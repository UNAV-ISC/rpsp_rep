...
class _CountrySelect extends GetView<EditProfileController> {
    ...
    return ProfileDataInfo(
      ...
      widget: Obx(
        () => DropdownButtonFormField(
          ...
          iconSize: 40,
          value: _.country.value.isEmpty ? null : _.country.value,
          items: genderList.map((items) {
            return DropdownMenuItem<String>(value: items, child: Text(items));
          }).toList(),
          onChanged: (String? value) => _.country.value = value!,
